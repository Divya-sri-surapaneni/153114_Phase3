...
public class TestClass {
	...
	public void testshowBalance() throws InvalidInputException {
		...
		Customer customer = service.showBalance(number);
		
		assertNotEquals(null,customer);
	}
	
	@Test
	public void testWithdrawAmount11() throws InvalidInputException, InsufficientBalanceException {
		String name = "divya";
	...
	public void testWithdrawAmount12() throws InvalidInputException, InsufficientBalanceException {
		String name = "divya";
	...
	@Test
	public void testDepositAmount7() throws InvalidInputException {
		String name = "divya";
	...
	public void testDepositAmount8() throws InvalidInputException {
		String name = "divya";
